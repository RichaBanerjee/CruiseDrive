...
class CruiseDrive
{
    public static void main(String[] args)
    {
        ...
        String dbAddress = "jdbc:mysql://localhost:3306/cruisedrive";
        ...
        System.out.println("Welcome to Cruise Drive Car Renting System!");
        ...
        while (true) {
            ...
            if (choice == 4)
            {
                System.out.println("Thank You For Choosing Cruise Drive!!");
                break;
            }
            ...
            else if (choice == 1)
            {
                ...
                {
                    System.out.println();
                    System.out.println("-------Sub-menu: Operations for Administrator-------");
                    System.out.println("What kind of operation would you like to perform?");
                    System.out.println("1. Create all tables");
                    System.out.println("2. Delete all tables");
                    System.out.println("3. Load data from the datafiles");
                    System.out.println("4. Show the number of records in each table of the database");
                    ...
                    else if (choice1 == 1)
                    {
                        ...
                        System.out.println("Done. Database is Initialized with the table schemas.");
                    }
                    ...
                    else if (choice1 == 2)
                    {
                        ...
                        {
                            System.out.println("...Failed to delete the tables");
                            continue;
                        }

                        System.out.println("Done. All the tables from the database are deleted");
                    }
                    ...
                    else if (choice1 == 4)
                    {
                        ...
                        {
                            System.out.println("Failed to show records.");
                        }
                    }

                    else
                    {
                        System.out.println("INVALID INPUT.PLEASE ENTER A NUMBER FROM GIVEN OPTIONS.");
                    }
                }
            }
            ...
            else if (choice == 2)
            {
                ...
                {
                    System.out.println();
                    System.out.println("-----Sub-menu: Operations for User-----");
                    System.out.println("What kind of operation would you like to perform?");
                    ...
                    else if (choice2 == 1)
                    {
                        while (true)
                        {
                            System.out.println("Search criterions:");
                            ...
                            if (choice21 == 1)
                            {
                                ...
                                {
                                    System.out.println("Failed to search for cars.");
                                    continue;
                                }
                                break;
                            }
                    ...
                    else if (choice2 == 2)
                    {
                        ...
                        {
                            System.out.println("Failed to show the Loan Records.");
                            continue;
                        }
            ...
            else if (choice == 3)
            {
                ...
                {
                    System.out.println();
                    System.out.println("-----Sub-menu: Operations for Manager-----");
                    System.out.println("What kind of operation would you like to perform?");
                    ...
                    else if (choice3 == 3)
                    {
                        ...
                        {
                            System.out.println("Failed to list unreturned cars");
                            continue;
                        }
    ...
    // load data from the dataset into the tables of database
    public static void loadData(Connection con, String path) throws Exception
    {
        Scanner file = null;
        Statement stmt = null;

        // load data from user_category.txt into user_category table
        file = new Scanner(new File(path + "/user_category.txt"));
        while (file.hasNextLine())
        {
            String line = file.nextLine();
            String[] attributes = line.split("\t"); // \t = tab
        ...
        // load data from user.txt into user table
        ...
        // load data from car_category.txt into car_category table
    ...
    public static boolean rentCar(Connection con, String userID, String callNum, int copyNum)
    {
        try
        {
            ...
            else
            {
                ...
                {
                    System.out.println("[Error]: This user has rented the maximum number of cars.");
                    return false;
                }
